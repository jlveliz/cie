...
use Cie\Exceptions\BuildingTherapyAvailableException;
use Illuminate\Http\Request;
use Validator;
/**
* 
*/
class BuildingTherapyAvailableValidator extends Validator implements ValidatorInterface
{
	private $request;
	...
	public function make(Request $request){
        ...
        if ($validator->fails()){
        	throw new BuildingTherapyAvailableException(['title'=>'Error de validación','detail'=>$validator->errors()->toJson(),'level'=>'error'],422);        
        } else {
        	return true;
        } 
	}
