...
use Cie\Exceptions\TherapyTherapyUserException;
use Illuminate\Http\Request;
use Validator;
/**
* 
*/
class TherapyValidator extends Validator implements ValidatorInterface
{
	private $request;
	...
	public function make(Request $request){
        ...
        if ($validator->fails()){
        	throw new TherapyTherapyUserException(['title'=>'Error de validación','detail'=>$validator->errors()->toJson(),'level'=>'error'],422);        
        } else {
        	return true;
        } 
	}
