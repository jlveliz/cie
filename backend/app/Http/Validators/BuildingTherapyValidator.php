...
* 
*/
class BuildingTherapyValidator extends Validator implements ValidatorInterface
{
	private $request;
	...
	public function make(Request $request){
        ...
        if ($validator->fails()){
        	throw new BuildingTherapyException(['title'=>'Error de validación','detail'=>$validator->errors()->toJson(),'level'=>'error'],422);        
        } else {
        	return true;
        } 
	}
